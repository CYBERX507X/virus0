...
def about():
	...
	print("\tAuthor  : Lukman\t\t\t")
	print("\tVersion : 99999\t\t\t")
	print("\tTeam    : "+R+"System eror")
	print("\t"+B+"Thanks to Lukman")
	menu()
